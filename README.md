...
- Alternatively, use the color scheme `Custom` to point to a .jpg or .webp file named `wallpaper` within `theme-customizations\canvas\` or `themes\canvas-es\wallpapers`as determined by the distribution choice above.
